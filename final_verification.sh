...
if [[ $FAIL -eq 0 ]]; then
    ...
    echo "3. 测试arm64: ./test_remote_machine.sh 192.168.101.70 8022 <仓库URL>"
    echo "4. 测试arm32: ./test_remote_machine.sh 192.168.101.38 8022 <仓库URL>"
...
echo "- 测试机1 (192.168.101.70): termux-apt arm64"
echo "- 测试机2 (192.168.101.38): termux-apt arm32"